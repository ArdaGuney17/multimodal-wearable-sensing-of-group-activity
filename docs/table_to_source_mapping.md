...
| Task 1 — interaction detection | Ch.7 §7.3 (Tables 7.1, 7.2) | `github notebooks/actual ones/task1_full_comparison_classical_elapsed_dl_with_std.ipynb` | `src/models/task1.py` | ⬜ |
