...
| Part IV (cell 15) — merge II+III into publication tables | assembles the final Table 8.4-shaped panel (Segment Markov from Part II + 3 neural rows from Part III) | not started, but both inputs it needs now exist | ⬜ |
